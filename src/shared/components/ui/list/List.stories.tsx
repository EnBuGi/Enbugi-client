      ...
      <div className="w-full rounded-2xl border border-white/10 bg-background p-8">
        ...
        <List {...args}>
          ...
          <ListRow
            title={
              <span className="inline-flex items-center gap-2">
                title only{' '}
                <span className="text-xs text-white/40">(truncate test)</span>
              </span>
            }
            href="/"
          />
          ...
          <ListRow
            ...
            description={
              <span className="text-white/60">
                description은 2줄 clamp. 길어지면 여기서부터 말줄임 처리됨. 아주
                길게 써서 line-clamp가 동작하는지 테스트해보자.
              </span>
            }
            href="/"
          />
          ...
          <ListRow
            title="trailing only"
            description={
              <span className="text-white/60">오른쪽 끝에 고정(shrink-0)</span>
            }
            trailing={
      ...
      <div className="w-full rounded-2xl border border-white/10 bg-background p-8">
        ...
        <List {...args}>
          <ListRow
            ...
            title="tone: default"
            description={
              <span className="text-white/60">기본 border/ring</span>
            }
            trailing={
              <ChevronRight
                className="h-5 w-5 text-white/35"
          ...
          <ListRow
            ...
            title="tone: success"
            description={
              <span className="text-white/60">emerald border/ring 강조</span>
            }
            trailing={
              <div className="flex items-center gap-4">
                <Score value={100} />
          ...
          <ListRow
            ...
            title="tone: danger"
            description={
              <span className="text-white/60">brand red border/ring 강조</span>
            }
            trailing={
              <div className="flex items-center gap-4">
                <Score value={64} />
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-background p-6">
          ...
          <List {...args} divider>
            ...
            <ListRow
              title="제출 이력"
              description="최근 제출 내역"
              trailing="8개"
              href="/"
            />
            <ListRow
              title="채점 결과"
              description="테스트 케이스별"
              trailing="12개"
              href="/"
            />
          </List>
