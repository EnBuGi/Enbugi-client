    ...
    <div className="text-white/80 p-6 bg-white/5 border border-white/10 rounded-xl backdrop-blur-md">
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <Text variant="h4" className="font-bold text-white">배점 구성</Text>
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              <Clock size={14} className="text-amber-400" />
              <Text variant="small" className="text-white/50">{scorePolicy.timeLimit}ms</Text>
            </div>
            <div className="flex items-center gap-2">
              <Database size={14} className="text-indigo-400" />
              <Text variant="small" className="text-white/50">{scorePolicy.memoryLimit}MB</Text>
            </div>
            <div className="h-4 w-px bg-white/10 mx-1" />
            <Text variant="small" className="font-bold text-emerald-400">총 {totalScore}점</Text>
          </div>
        </div>
              ...
              <div className="relative p-5 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <Text variant="tiny" className="text-white/40 block opacity-60">
                      {test.isHidden 
                ...
                <div className="flex flex-col items-end">
                  <Text variant="tiny" className="text-white/30 uppercase font-bold tracking-widest">배점</Text>
                  <div className="flex items-baseline gap-0.5">
                    ...
                    <Text variant="tiny" className="text-white/50 font-bold">점</Text>
                  </div>
                </div>
              </div>
            </div>
