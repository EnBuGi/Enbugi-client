...
import { MySubmissionsTable } from '@/features/mentee-submissions/ui/MySubmissionsTable';
  ...
  return (
    <div className="flex flex-col gap-8 w-full max-w-[1200px] mx-auto px-8 py-8">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-2xl font-bold text-white">내 제출 현황</h1>
        <Text variant="large" className="font-medium text-zinc-400">
          내가 제출한 모든 과제의 기록을 확인하고 결과를 검토하세요
        </Text>
      </div>
